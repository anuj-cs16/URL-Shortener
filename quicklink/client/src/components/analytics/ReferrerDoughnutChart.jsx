/**
 * @file       ReferrerDoughnutChart.jsx
 * @description Doughnut chart wrapping traffic referrer parameters (traffic source).
 * @module     components/analytics/ReferrerDoughnutChart
 * @requires   react
...
const ReferrerDoughnutChart = ({ data = [], isLoading = false }) => {
  if (isLoading) {
  ...
  const chartData = {
    ...
    datasets: [
      {
        data: values,
        backgroundColor: ['#3ECFCF', '#6C63FF', '#FFD93D', '#FF5252', '#8B85FF'],
        borderColor: '#16213E',
        borderWidth: 2,
      },
    ],
  ...
  return (
    <div className="glass-card chart-card-container">
      <h3 className="chart-title-lbl">Traffic Sources</h3>
...
export default ReferrerDoughnutChart;
